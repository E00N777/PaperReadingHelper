...
def get_results(
    ...
    # New code:
    language="Cpp", scanner="dfbscan", model="deepseek-chat", bug_type="NPD"
) -> list:
...
def display_home():
    ...
    st.markdown(
        """
**RepoAudit** is a repo-level bug detector for general bugs. It is now focused on **C/C++** code auditing, including bug types such as Null Pointer Dereference, Memory Leak, and Use After Free. It leverages **LLMSCAN** to parse the codebase and uses **LLM** to mimic the process of manual code auditing.

### Advantages
- **Compilation-Free Analysis**
- **C/C++ Focused Analysis**
...
def display_results():
    ...
    model = st.selectbox(
        ...
        [
            ...
            "deepseek-reasoner",
            "glm-5",
            # Original code kept below for compatibility:
            "claude-3.5",
            "claude-3.7",
            "o3-mini",
            "gpt-4o",
